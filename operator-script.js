    ...
    function drawOrders(data) {
        ...
        if (data.length) {
            ...
            data.forEach(function (order, idx) {
                ...
                // }, ));
                orderListItemBlock.append($('<div class="dropdown js-change-order-status"><button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="img/arrow-down.svg" width="15" height="15" alt="Стрелка вниз - раскрыть детали"></button><div class="dropdown-menu" aria-labelledby="dropdownMenuButton">  <a class="dropdown-item" data-status-id="2" href="#">В работе</a>  <a class="dropdown-item" data-status-id="3" href="#">Отклонена</a>  <a class="dropdown-item" data-status-id="4" href="#">Выполнена</a></div></div>'));
